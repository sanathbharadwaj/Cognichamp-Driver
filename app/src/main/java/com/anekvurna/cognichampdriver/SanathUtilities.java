...
public class SanathUtilities {
    ...
    {
        editor = context.getSharedPreferences("com.anekvurna.cognichampdriver", MODE_PRIVATE).edit();
        preferences = context.getSharedPreferences("com.anekvurna.cognichampdriver", MODE_PRIVATE);
    }
